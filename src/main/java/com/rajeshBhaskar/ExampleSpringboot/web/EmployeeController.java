package com.rajeshBhaskar.ExampleSpringboot.web;
...
import com.rajeshBhaskar.ExampleSpringboot.service.EmployeeService;
...
public class EmployeeController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> updateEmployee(@PathVariable Long id, @RequestBody EmployeeEntity employeeDTO) {
